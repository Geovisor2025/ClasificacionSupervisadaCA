...
var style_MuestrasCampo_6 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelFill = "#c32323";
    var bufferColor = "#e8e8e8";
    var bufferWidth = 3.0;
    ...
    if (size == 1) { // If cluster has one feature
        ...
        if (feature.get("Cult.Campo") !== null) {
            labelText = String(feature.get("Cult.Campo"));
        }
    ...
    var style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 6.4 + size,
            displacement: [0, 0], stroke: new ol.style.Stroke({color: 'rgba(0,0,255,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 2.28}), fill: new ol.style.Fill({color: 'rgba(141,90,153,0.054901960784313725)'})}),
